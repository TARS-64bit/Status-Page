...
const NoServiceFound = () => {
    return (
        <div className="flex flex-col items-center justify-center ">
            ...
            <h2 className="text-xl font-semibold text-gray-600 mt-10">No Services Found</h2>
            <p className="text-gray-500 mt-2 text-center">Services are the functioning pieces of your website or application, add some to view them here.</p>
        </div>
    );
};
